  ...
  array.forEach((item) => {
    ...
    <div class="card" style="width: 18rem;">
      <div class="card-body">
        ...
        <p class="card-text bold">${item.favorite ? `<span class="badge badge-info sale-badge"><i class="fa fa-bell" aria-hidden="true"></i>Favorite</span> ${item.favorite}` : `${item.favorite}`}</p>
        <hr>
